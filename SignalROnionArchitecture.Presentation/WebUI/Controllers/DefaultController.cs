...
using SignalROnionArchitecture.Presentation.WebUI.Dtos.MessageDtos;
...

{
    ...
    public class DefaultController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            HttpResponseMessage response = await client.GetAsync("https://localhost:7068/api/Contact");
        ...
        public async Task<IActionResult> SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7068/api/Message", stringContent);
